...
Symbolic music generation represents music as structured symbolic events, such
...
modeled with autoregressive neural language models. The practical focus is the
development of an xLSTM-based system for generating symbolic music continuations
from a given prompt. The work therefore combines several engineering tasks that
