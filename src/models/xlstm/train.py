...
# TODO: remove dependencies that are not needed for my use case
...
# TODO: implement my own dataloaders and datasets
def load_dataset(name, kwargs):
    if name not in dataset_registry:
        raise ValueError(
            f"Unknown dataset '{name}'. Add it to dataset_registry in src/models/xlstm/train.py."
        )
...
def main(cfg: DictConfig):
    ...
    # Constant LR placeholder until a custom scheduler is wired.
